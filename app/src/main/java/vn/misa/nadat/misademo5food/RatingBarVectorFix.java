package vn.misa.nadat.misademo5food;
...
public class RatingBarVectorFix extends AppCompatRatingBar {
    ...
    private void init() {
        ...
        drawable.findDrawableByLayerId(android.R.id.background).setColorFilter(R.drawable.ic_rate_empty_big, PorterDuff.Mode.DST);
        drawable.findDrawableByLayerId(android.R.id.progress).setColorFilter(R.drawable.ic_rate_fill_big, PorterDuff.Mode.DST);
